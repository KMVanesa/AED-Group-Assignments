...
public class AdminCreateScreen extends javax.swing.JPanel {
     ...
     */
    //private AdminMainScreen main=new AdminMainScreen(this, null);
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        try {
            ...
            }else if(Pattern.matches("^\\w+[\\w-\\.]*\\@\\w+((-\\w+)|(\\w*))\\.[a-z]{2,3}$", Username)==false){
       ...
       try {
             if(radioCustomer.isSelected()==false && radioAirliner.isSelected()==false){
        ...
        //SupplierDirectory supplier = new AirlinerDirectory();
